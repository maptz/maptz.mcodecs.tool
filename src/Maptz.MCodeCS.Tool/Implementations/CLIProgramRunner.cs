    ...
    public class CLIProgramRunner : ICliProgramRunner
    {
        ...
        public async Task RunAsync(string[] args)
        {
            await Task.Run(() =>
            {
                ...
                cla.Command("create-settings", config => WireUpEngineMethod(config, this.ExtensionEngine.CreateSettingsAsync));
                cla.Command("extract-class", config => WireUpEngineMethod(config, this.ExtensionEngine.ExtractClassAsync));
                cla.Command("expand-property", config => WireUpEngineMethod(config, this.ExtensionEngine.ExpandPropertyAsync));
